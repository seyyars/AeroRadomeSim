...
\begin{figure}[t]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/q_vs_mach.png}
  \caption{Dynamic pressure as a function of Mach number at a representative altitude.}
  \label{fig:temp_mach}
\end{figure}

\begin{figure}[t]
  \centering
  \includegraphics[width=0.7\textwidth]{figures/radome_s21_T300K.png}
  \caption{Example radome transmission \emph{vs} frequency at $T=300\,\mathrm{K}$.}
  \label{fig:loss_mach}
\end{figure}
